...
export const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Да, я предоставляю 100% гарантию восстановления. За 2 года работы я восстановил доступ ко всем аккаунтам без исключения. Если не смогу разблокировать ваш Вацап, верну деньги полностью.",
    },
    {
    ...
    },
    {
      ...
      answer: "Да, я специализируюсь на восстановлении как личных, так и бизнес-аккаунтов Вацап. Процесс может отличаться, но результат гарантирован.",
    },
    {
    ...
    },
    {
      ...
      answer: "Да, я работаю с номерами из любых стран. География не влияет на возможность восстановления доступа к Вацап.",
    },
    {
      question: "Что делать, если аккаунт заблокировали повторно?",
      answer: "После восстановления мы предоставляем рекомендации по безопасному использованию Вацап. При соблюдении моих советов повторная блокировка крайне маловероятна.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Ответы на самые популярные вопросы о разблокировке Вацап
          </p>
        </div>
