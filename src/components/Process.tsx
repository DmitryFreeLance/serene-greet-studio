...
export const Process = () => {
  const steps = [
    ...
    },
    {
      ...
      number: "04",
      title: "Результат",
      description: "Получаете полностью восстановленный доступ к Вацап со всеми контактами и историей сообщений.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            Простой и прозрачный процесс восстановления доступа к вашему Вацап
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4 p-6 bg-gradient-to-r from-primary/10 to-accent/10 rounded-xl">
            ...
            <div className="text-left">
              <h3 className="font-bold text-white">100% гарантия восстановления</h3>
              <p className="text-sm text-white/80">Возвращаю деньги, если не смогу разблокировать ваш аккаунт</p>
            </div>
          </div>
        </div>
